...
project = "adv-jax-math"
copyright = "2026, Kaya Unalmis"
author = "Kaya Unalmis"
version = adv_jax_math.__version__
release = version
...
# Source-link options
top_level = "adv_jax_math"
linkcode_blob = "head"
linkcode_url = r"https://github.com/unalmis/adv-jax-math"
...
htmlhelp_basename = "adv-jax-math"
...
latex_elements = {
    ...
    \begin{titlepage}
        ...
        \centering
        \textbf{\Huge {adv-jax-math Documentation}}
